...
any_example{host="https://...",hosting_vendor="MyExampleHoster",hosting_rate="FastWPHosting"} 545 <?= hrtime() ?>
</textarea>
            ...
            <section>
                ...
                <table class="widefat striped health-check-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <th><?= _x( 'Legacy parameter', 'Site Health', 'prometheus-metrics-for-wp' ) ?></th>
					...
					foreach ( $metrics as $metric ) {
                        ...
                        <tr>
                            ...
                            <td><?= $metric->legacy_get_param ?></td>
                            <td><?= $metric->get_help_text() ?></td>
                            <td><code><?= $metric->metric_name ?>=yes</code> <br/>
                                <code><?= $metric->metric_name ?>=no</code></td>
                        </tr>
						<?php
					}
					?>
